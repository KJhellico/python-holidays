...
.. code-block:: bash
    ...
    $ pip install --upgrade https://kjhellico.github.io/python-holidays/holidays-0.27-py3-none-any.whl

or tarball:

.. code-block:: bash

    $ pip install --upgrade https://kjhellico.github.io/python-holidays/holidays-0.27.tar.gz
