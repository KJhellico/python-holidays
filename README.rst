...
.. code-block:: bash
    ...
    $ pip install --upgrade --force-reinstall https://kjhellico.github.io/python-holidays/holidays-0.31-py3-none-any.whl

or tarball:

.. code-block:: bash

    $ pip install --upgrade --force-reinstall https://kjhellico.github.io/python-holidays/holidays-0.31.tar.gz
